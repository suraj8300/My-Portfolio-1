...
const projects = [
    ...
    },
    {
        name: "Project Beta",
        links: [
            { label: "Demo", url: "https://example.com/project-beta-demo" }
        ]
    },
    {
        name: "Project Gamma",
        links: [
            { label: "Live Site", url: "https://example.com/project-gamma" },
            { label: "GitHub Repo", url: "https://github.com/yourprofile/project-gamma" }
        ]
    },
